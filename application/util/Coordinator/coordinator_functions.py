...
def save_club_details(club_id, club_name, club_description):
    dbf.query_db(ecd.save_club_details.format(club_id=club_id, club_name=club_name, club_description=club_description))
...
def insert_new_event(club_id, event_name, event_description, timestamp):
    cursor.execute(ecd.insert_new_event.format(club_id=club_id, event_name=event_name, event_description=event_description, timestamp=timestamp))
