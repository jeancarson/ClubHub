...
class Response:
    ...
    This class is not meant for util use. It should only be used when
    ...
    date = header_property(
        ...
        parse_date,
        http_date,
        doc="""The Date util-header field represents the date and
    ...
    def cache_control(self) -> ResponseCacheControl:
        """The Cache-Control util-header field is used to specify
