...
LEXERS = {
    ...
    'Angular2HtmlLexer': ('pip._vendor.pygments.lexers._templates', 'HTML + Angular2', ('html+ng2',), ('*.ng2',), ()),
    'Angular2Lexer': ('pip._vendor.pygments.lexers._templates', 'Angular2', ('ng2',), (), ()),
    ...
    'CheetahHtmlLexer': ('pip._vendor.pygments.lexers._templates', 'HTML+Cheetah', ('html+cheetah', 'html+spitfire', 'htmlcheetah'), (), ('text/html+cheetah', 'text/html+spitfire')),
    'CheetahJavascriptLexer': ('pip._vendor.pygments.lexers._templates', 'JavaScript+Cheetah', ('js+cheetah', 'js+cheetah', 'js+spitfire', 'js+spitfire'), (), ('application/x-js+cheetah', 'text/x-js+cheetah', 'text/js+cheetah', 'application/x-js+spitfire', 'text/x-js+spitfire', 'text/js+spitfire')),
    'CheetahLexer': ('pip._vendor.pygments.lexers._templates', 'Cheetah', ('cheetah', 'spitfire'), ('*.tmpl', '*.spt'), ('application/x-cheetah', 'application/x-spitfire')),
    'CheetahXmlLexer': ('pip._vendor.pygments.lexers._templates', 'XML+Cheetah', ('xml+cheetah', 'xml+spitfire'), (), ('application/xml+cheetah', 'application/xml+spitfire')),
    ...
    'CoffeeScriptLexer': ('pip._vendor.pygments.lexers.js', 'CoffeeScript', ('coffeescript', 'coffee-script', 'coffee'), ('*.coffee',), ('text/coffeescript',)),
    'ColdfusionCFCLexer': ('pip._vendor.pygments.lexers._templates', 'Coldfusion CFC', ('cfc',), ('*.cfc',), ()),
    'ColdfusionHtmlLexer': ('pip._vendor.pygments.lexers._templates', 'Coldfusion HTML', ('cfm',), ('*.cfm', '*.cfml'), ('application/x-coldfusion',)),
    'ColdfusionLexer': ('pip._vendor.pygments.lexers._templates', 'cfstatement', ('cfs',), (), ()),
    ...
    'CssDjangoLexer': ('pip._vendor.pygments.lexers._templates', 'CSS+Django/Jinja', ('css+django', 'css+jinja'), ('*.css.j2', '*.css.jinja2'), ('text/css+django', 'text/css+jinja')),
    'CssErbLexer': ('pip._vendor.pygments.lexers._templates', 'CSS+Ruby', ('css+ruby', 'css+erb'), (), ('text/css+ruby',)),
    'CssGenshiLexer': ('pip._vendor.pygments.lexers._templates', 'CSS+Genshi Text', ('css+genshitext', 'css+genshi'), (), ('text/css+genshi',)),
    'CssLexer': ('pip._vendor.pygments.lexers.css', 'CSS', ('css',), ('*.css',), ('text/css',)),
    'CssPhpLexer': ('pip._vendor.pygments.lexers._templates', 'CSS+PHP', ('css+php',), (), ('text/css+php',)),
    'CssSmartyLexer': ('pip._vendor.pygments.lexers._templates', 'CSS+Smarty', ('css+smarty',), (), ('text/css+smarty',)),
    ...
    'DartLexer': ('pip._vendor.pygments.lexers.js', 'Dart', ('dart',), ('*.dart',), ('text/x-dart',)),
    ...
    'DjangoLexer': ('pip._vendor.pygments.lexers._templates', 'Django/Jinja', ('django', 'jinja'), (), ('application/x-django-templating', 'application/x-jinja')),
    ...
    'EarlGreyLexer': ('pip._vendor.pygments.lexers.js', 'Earl Grey', ('earl-grey', 'earlgrey', 'eg'), ('*.eg',), ('text/x-earl-grey',)),
    ...
    'ErbLexer': ('pip._vendor.pygments.lexers._templates', 'ERB', ('erb',), (), ('application/x-ruby-templating',)),
    ...
    'EvoqueHtmlLexer': ('pip._vendor.pygments.lexers._templates', 'HTML+Evoque', ('html+evoque',), ('*.html',), ('text/html+evoque',)),
    'EvoqueLexer': ('pip._vendor.pygments.lexers._templates', 'Evoque', ('evoque',), ('*.evoque',), ('application/x-evoque',)),
    'EvoqueXmlLexer': ('pip._vendor.pygments.lexers._templates', 'XML+Evoque', ('xml+evoque',), ('*.xml',), ('application/xml+evoque',)),
    ...
    'GenshiLexer': ('pip._vendor.pygments.lexers._templates', 'Genshi', ('genshi', 'kid', 'xml+genshi', 'xml+kid'), ('*.kid',), ('application/x-genshi', 'application/x-kid')),
    'GenshiTextLexer': ('pip._vendor.pygments.lexers._templates', 'Genshi Text', ('genshitext',), (), ('application/x-genshi-text', 'text/x-genshi')),
    ...
    'HandlebarsHtmlLexer': ('pip._vendor.pygments.lexers._templates', 'HTML+Handlebars', ('html+handlebars',), ('*.handlebars', '*.hbs'), ('text/html+handlebars', 'text/x-handlebars-template')),
    'HandlebarsLexer': ('pip._vendor.pygments.lexers._templates', 'Handlebars', ('handlebars',), (), ()),
    ...
    'HtmlDjangoLexer': ('pip._vendor.pygments.lexers._templates', 'HTML+Django/Jinja', ('html+django', 'html+jinja', 'htmldjango'), ('*.html.j2', '*.htm.j2', '*.xhtml.j2', '*.html.jinja2', '*.htm.jinja2', '*.xhtml.jinja2'), ('text/html+django', 'text/html+jinja')),
    'HtmlGenshiLexer': ('pip._vendor.pygments.lexers._templates', 'HTML+Genshi', ('html+genshi', 'html+kid'), (), ('text/html+genshi',)),
    'HtmlLexer': ('pip._vendor.pygments.lexers.html', 'HTML', ('html',), ('*.html', '*.htm', '*.xhtml', '*.xslt'), ('text/html', 'application/xhtml+xml')),
    'HtmlPhpLexer': ('pip._vendor.pygments.lexers._templates', 'HTML+PHP', ('html+php',), ('*.phtml',), ('application/x-php', 'application/x-httpd-php', 'application/x-httpd-php3', 'application/x-httpd-php4', 'application/x-httpd-php5')),
    'HtmlSmartyLexer': ('pip._vendor.pygments.lexers._templates', 'HTML+Smarty', ('html+smarty',), (), ('text/html+smarty',)),
    ...
    'JavascriptDjangoLexer': ('pip._vendor.pygments.lexers._templates', 'JavaScript+Django/Jinja', ('js+django', 'js+django', 'js+jinja', 'js+jinja'), ('*.js.j2', '*.js.jinja2'), ('application/x-js+django', 'application/x-js+jinja', 'text/x-js+django', 'text/x-js+jinja', 'text/js+django', 'text/js+jinja')),
    'JavascriptErbLexer': ('pip._vendor.pygments.lexers._templates', 'JavaScript+Ruby', ('js+ruby', 'js+ruby', 'js+erb', 'js+erb'), (), ('application/x-js+ruby', 'text/x-js+ruby', 'text/js+ruby')),
    'JavascriptGenshiLexer': ('pip._vendor.pygments.lexers._templates', 'JavaScript+Genshi Text', ('js+genshitext', 'js+genshi', 'js+genshitext', 'js+genshi'), (), ('application/x-js+genshi', 'text/x-js+genshi', 'text/js+genshi')),
    'JavascriptLexer': ('pip._vendor.pygments.lexers.js', 'JavaScript', ('js', 'js'), ('*.js', '*.jsm', '*.mjs', '*.cjs'), ('application/js', 'application/x-js', 'text/x-js', 'text/js')),
    'JavascriptPhpLexer': ('pip._vendor.pygments.lexers._templates', 'JavaScript+PHP', ('js+php', 'js+php'), (), ('application/x-js+php', 'text/x-js+php', 'text/js+php')),
    'JavascriptSmartyLexer': ('pip._vendor.pygments.lexers._templates', 'JavaScript+Smarty', ('js+smarty', 'js+smarty'), (), ('application/x-js+smarty', 'text/x-js+smarty', 'text/js+smarty')),
    ...
    'JspLexer': ('pip._vendor.pygments.lexers._templates', 'Java Server Page', ('jsp',), ('*.jsp',), ('application/x-jsp',)),
    ...
    'JuttleLexer': ('pip._vendor.pygments.lexers.js', 'Juttle', ('juttle',), ('*.juttle',), ('application/juttle', 'application/x-juttle', 'text/x-juttle', 'text/juttle')),
    'KLexer': ('pip._vendor.pygments.lexers.q', 'K', ('k',), ('*.k',), ()),
    'KalLexer': ('pip._vendor.pygments.lexers.js', 'Kal', ('kal',), ('*.kal',), ('text/kal', 'application/kal')),
    'KconfigLexer': ('pip._vendor.pygments.lexers.configs', 'Kconfig', ('kconfig', 'menuconfig', 'linux-config', 'kernel-config'), ('Kconfig*', '*Config.in*', 'external.in*', 'standard-application.in'), ('text/x-kconfig',)),
    ...
    'LassoCssLexer': ('pip._vendor.pygments.lexers._templates', 'CSS+Lasso', ('css+lasso',), (), ('text/css+lasso',)),
    'LassoHtmlLexer': ('pip._vendor.pygments.lexers._templates', 'HTML+Lasso', ('html+lasso',), (), ('text/html+lasso', 'application/x-httpd-lasso', 'application/x-httpd-lasso[89]')),
    'LassoJavascriptLexer': ('pip._vendor.pygments.lexers._templates', 'JavaScript+Lasso', ('js+lasso', 'js+lasso'), (), ('application/x-js+lasso', 'text/x-js+lasso', 'text/js+lasso')),
    'LassoLexer': ('pip._vendor.pygments.lexers.js', 'Lasso', ('lasso', 'lassoscript'), ('*.lasso', '*.lasso[89]'), ('text/x-lasso',)),
    'LassoXmlLexer': ('pip._vendor.pygments.lexers._templates', 'XML+Lasso', ('xml+lasso',), (), ('application/xml+lasso',)),
    ...
    'LiquidLexer': ('pip._vendor.pygments.lexers._templates', 'liquid', ('liquid',), ('*.liquid',), ()),
    ...
    'LiveScriptLexer': ('pip._vendor.pygments.lexers.js', 'LiveScript', ('livescript', 'live-script'), ('*.ls',), ('text/livescript',)),
    ...
    'MakoCssLexer': ('pip._vendor.pygments.lexers._templates', 'CSS+Mako', ('css+mako',), (), ('text/css+mako',)),
    'MakoHtmlLexer': ('pip._vendor.pygments.lexers._templates', 'HTML+Mako', ('html+mako',), (), ('text/html+mako',)),
    'MakoJavascriptLexer': ('pip._vendor.pygments.lexers._templates', 'JavaScript+Mako', ('js+mako', 'js+mako'), (), ('application/x-js+mako', 'text/x-js+mako', 'text/js+mako')),
    'MakoLexer': ('pip._vendor.pygments.lexers._templates', 'Mako', ('mako',), ('*.mao',), ('application/x-mako',)),
    'MakoXmlLexer': ('pip._vendor.pygments.lexers._templates', 'XML+Mako', ('xml+mako',), (), ('application/xml+mako',)),
    ...
    'MaskLexer': ('pip._vendor.pygments.lexers.js', 'Mask', ('mask',), ('*.mask',), ('text/x-mask',)),
    'MasonLexer': ('pip._vendor.pygments.lexers._templates', 'Mason', ('mason',), ('*.m', '*.mhtml', '*.mc', '*.mi', 'autohandler', 'dhandler'), ('application/x-mason',)),
    ...
    'MozPreprocJavascriptLexer': ('pip._vendor.pygments.lexers.markup', 'Javascript+mozpreproc', ('js+mozpreproc',), ('*.js.in',), ()),
    ...
    'MyghtyCssLexer': ('pip._vendor.pygments.lexers._templates', 'CSS+Myghty', ('css+myghty',), (), ('text/css+myghty',)),
    'MyghtyHtmlLexer': ('pip._vendor.pygments.lexers._templates', 'HTML+Myghty', ('html+myghty',), (), ('text/html+myghty',)),
    'MyghtyJavascriptLexer': ('pip._vendor.pygments.lexers._templates', 'JavaScript+Myghty', ('js+myghty', 'js+myghty'), (), ('application/x-js+myghty', 'text/x-js+myghty', 'text/js+mygthy')),
    'MyghtyLexer': ('pip._vendor.pygments.lexers._templates', 'Myghty', ('myghty',), ('*.myt', 'autodelegate'), ('application/x-myghty',)),
    'MyghtyXmlLexer': ('pip._vendor.pygments.lexers._templates', 'XML+Myghty', ('xml+myghty',), (), ('application/xml+myghty',)),
    ...
    'NodeConsoleLexer': ('pip._vendor.pygments.lexers.js', 'Node.js REPL console session', ('nodejsrepl',), (), ('text/x-nodejsrepl',)),
    ...
    'ObjectiveJLexer': ('pip._vendor.pygments.lexers.js', 'Objective-J', ('objective-j', 'objectivej', 'obj-j', 'objj'), ('*.j',), ('text/x-objective-j',)),
    ...
    'RhtmlLexer': ('pip._vendor.pygments.lexers._templates', 'RHTML', ('rhtml', 'html+erb', 'html+ruby'), ('*.rhtml',), ('text/html+ruby',)),
    ...
    'SmartyLexer': ('pip._vendor.pygments.lexers._templates', 'Smarty', ('smarty',), ('*.tpl',), ('application/x-smarty',)),
    ...
    'SqlJinjaLexer': ('pip._vendor.pygments.lexers._templates', 'SQL+Jinja', ('sql+jinja',), ('*.sql', '*.sql.j2', '*.sql.jinja2'), ()),
    ...
    'SspLexer': ('pip._vendor.pygments.lexers._templates', 'Scalate Server Page', ('ssp',), ('*.ssp',), ('application/x-ssp',)),
    ...
    'TeaTemplateLexer': ('pip._vendor.pygments.lexers._templates', 'Tea', ('tea',), ('*.tea',), ('text/x-tea',)),
    ...
    'TwigHtmlLexer': ('pip._vendor.pygments.lexers._templates', 'HTML+Twig', ('html+twig',), ('*.twig',), ('text/html+twig',)),
    'TwigLexer': ('pip._vendor.pygments.lexers._templates', 'Twig', ('twig',), (), ('application/x-twig',)),
    'TypeScriptLexer': ('pip._vendor.pygments.lexers.js', 'TypeScript', ('typescript', 'ts'), ('*.ts',), ('application/x-typescript', 'text/x-typescript')),
    ...
    'VelocityHtmlLexer': ('pip._vendor.pygments.lexers._templates', 'HTML+Velocity', ('html+velocity',), (), ('text/html+velocity',)),
    'VelocityLexer': ('pip._vendor.pygments.lexers._templates', 'Velocity', ('velocity',), ('*.vm', '*.fhtml'), ()),
    'VelocityXmlLexer': ('pip._vendor.pygments.lexers._templates', 'XML+Velocity', ('xml+velocity',), (), ('application/xml+velocity',)),
    ...
    'XmlDjangoLexer': ('pip._vendor.pygments.lexers._templates', 'XML+Django/Jinja', ('xml+django', 'xml+jinja'), ('*.xml.j2', '*.xml.jinja2'), ('application/xml+django', 'application/xml+jinja')),
    'XmlErbLexer': ('pip._vendor.pygments.lexers._templates', 'XML+Ruby', ('xml+ruby', 'xml+erb'), (), ('application/xml+ruby',)),
    ...
    'XmlPhpLexer': ('pip._vendor.pygments.lexers._templates', 'XML+PHP', ('xml+php',), (), ('application/xml+php',)),
    'XmlSmartyLexer': ('pip._vendor.pygments.lexers._templates', 'XML+Smarty', ('xml+smarty',), (), ('application/xml+smarty',)),
    ...
    'YamlJinjaLexer': ('pip._vendor.pygments.lexers._templates', 'YAML+Jinja', ('yaml+jinja', 'salt', 'sls'), ('*.sls', '*.yaml.j2', '*.yml.j2', '*.yaml.jinja2', '*.yml.jinja2'), ('text/x-yaml+jinja', 'text/x-sls')),
