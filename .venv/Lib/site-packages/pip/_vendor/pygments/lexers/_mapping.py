...
LEXERS = {
    ...
    'CheetahJavascriptLexer': ('pip._vendor.pygments.lexers.templates', 'JavaScript+Cheetah', ('js+cheetah', 'js+cheetah', 'js+spitfire', 'js+spitfire'), (), ('application/x-js+cheetah', 'text/x-js+cheetah', 'text/js+cheetah', 'application/x-js+spitfire', 'text/x-js+spitfire', 'text/js+spitfire')),
    ...
    'JavascriptDjangoLexer': ('pip._vendor.pygments.lexers.templates', 'JavaScript+Django/Jinja', ('js+django', 'js+django', 'js+jinja', 'js+jinja'), ('*.js.j2', '*.js.jinja2'), ('application/x-js+django', 'application/x-js+jinja', 'text/x-js+django', 'text/x-js+jinja', 'text/js+django', 'text/js+jinja')),
    'JavascriptErbLexer': ('pip._vendor.pygments.lexers.templates', 'JavaScript+Ruby', ('js+ruby', 'js+ruby', 'js+erb', 'js+erb'), (), ('application/x-js+ruby', 'text/x-js+ruby', 'text/js+ruby')),
    'JavascriptGenshiLexer': ('pip._vendor.pygments.lexers.templates', 'JavaScript+Genshi Text', ('js+genshitext', 'js+genshi', 'js+genshitext', 'js+genshi'), (), ('application/x-js+genshi', 'text/x-js+genshi', 'text/js+genshi')),
    ...
    'JavascriptPhpLexer': ('pip._vendor.pygments.lexers.templates', 'JavaScript+PHP', ('js+php', 'js+php'), (), ('application/x-js+php', 'text/x-js+php', 'text/js+php')),
    'JavascriptSmartyLexer': ('pip._vendor.pygments.lexers.templates', 'JavaScript+Smarty', ('js+smarty', 'js+smarty'), (), ('application/x-js+smarty', 'text/x-js+smarty', 'text/js+smarty')),
    ...
    'LassoJavascriptLexer': ('pip._vendor.pygments.lexers.templates', 'JavaScript+Lasso', ('js+lasso', 'js+lasso'), (), ('application/x-js+lasso', 'text/x-js+lasso', 'text/js+lasso')),
    ...
    'MakoJavascriptLexer': ('pip._vendor.pygments.lexers.templates', 'JavaScript+Mako', ('js+mako', 'js+mako'), (), ('application/x-js+mako', 'text/x-js+mako', 'text/js+mako')),
    ...
    'MyghtyJavascriptLexer': ('pip._vendor.pygments.lexers.templates', 'JavaScript+Myghty', ('js+myghty', 'js+myghty'), (), ('application/x-js+myghty', 'text/x-js+myghty', 'text/js+mygthy')),
